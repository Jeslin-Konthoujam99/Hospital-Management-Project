		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-white">
					<li class="text-center h4 fw-bold">LAB DASHBOARD</li>
				</ul>
				<div class="dropdown">
					<a
						...
						src="Photo/Employee.png" class="rounded-circle" height="30"
			...
			<div class="bg-dark text-white fs-1 text-center fixed-top mt-5"
				...
				<div class="dropend">
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						...
						<li><a class="dropdown-item" href="lab/insert_opd_test_bill.jsp" 
						 target="frame">Insert OPD TestBill</a></li>
						
						<li><a class="dropdown-item" href="lab/insert_opd_test_result.jsp"
							target="frame">Insert OPD Test Result</a></li>
							
						<li><a class="dropdown-item" href="lab/view_opd_test_result.jsp"
							target="frame">View OPD Result</a></li>
				...
				<div class="dropend">
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						...
						<li><a class="dropdown-item" href="lab/insert_ipd_test_bill.jsp" 
							target="frame">Insert IPD TestBill</a></li>
						
						<li><a class="dropdown-item" href="lab/insert_ipd_test_result.jsp"
							target="frame">Insert IPD Test Result</a></li>
							
						<li><a class="dropdown-item" href="lab/view_ipd_test_result.jsp"
							target="frame">View IPD Result</a></li>
								
					</ul>
				</div>

			</div>
			<iframe src="lab/view_opd_test_result.jsp" width="100%" id="frame"
