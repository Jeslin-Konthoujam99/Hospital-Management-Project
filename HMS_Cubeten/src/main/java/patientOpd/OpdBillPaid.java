...
public class OpdBillPaid extends HttpServlet {
	        ...
	        try {
	         ...
	         // Fetch data from book_appointment
	            ...
	            String appointmentQuery = 
	            		"SELECT * FROM opd_appointments WHERE booked_id = ?";
	            ...
	            String patientQuery =
	            		"SELECT fullname FROM patients WHERE patientid = ?";
	            ...
	            String doctorQuery = 
	            "SELECT firstname , lastname FROM employeelist WHERE employee_id = ?";
	...
	// Update appointment status
	            String updateQuery = 
	       "UPDATE opd_appointments SET appointment_status = 'confirmed' WHERE booked_id = ?";
