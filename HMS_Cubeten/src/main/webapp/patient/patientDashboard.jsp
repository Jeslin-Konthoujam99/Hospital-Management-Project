		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-white">
					<li class="text-center h4 fw-bold">PATIENT DASHBOARD</li>
				</ul>
				<div class="dropdown">
					<a
					...
					<ul class="dropdown-menu dropdown-menu-end my-4"
						...
						<li><a class="dropdown-item"
							href="patient/select_opd_department.jsp" target="frame">Home</a></li>
			...
			<div class="bg-dark text-white fs-1 text-center fixed-top mt-5"
				...
				<div class="dropend">
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						aria-labelledby="navbarDropdownMenuAvatar">
						<li><a class="dropdown-item"
							href="patient/select_opd_department.jsp" target="frame">Book OPD Appointment</a></li>
						<li><a class="dropdown-item"
							href="patient/ipdappointment.jsp" target="frame">Book IPD Appointment</a></li>
					</ul>
				</div>
				<div class="dropend">
					<a class="dropdown-toggle align-items-center hidden-arrow"
					 href="#" id="navbarDropdownMenuAvatar" role="button"
						data-mdb-toggle="dropdown" aria-expanded="false"><img
						src="Photo/Time.png" class="rounded-circle my-3 img-fulid"
						height="50px" width="50px" alt="User" loading="lazy" />
					 </a>
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						aria-labelledby="navbarDropdownMenuAvatar">
						<li><a class="dropdown-item"
							href="patient/appointments_history.jsp"
							 target="frame">
							 OPD Appointment History/Bill Payment</a></li>
						<li><a class="dropdown-item"
							href="patient/viewappointment.jsp" target="frame">
							IPD Appointment History/Bill Payment</a></li>

					</ul>
				</div>
			</div>
			<iframe src="patient/select_opd_department.jsp" width="100%" id="frame"
