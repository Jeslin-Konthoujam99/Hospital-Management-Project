	...
	<div class="container-fluid">
		<div class="row d-md-block d-lg-flex g-4">
			...
			<div class="col-md-12 col-lg-6 d-none d-lg-block">
				<img src="${pageContext.request.contextPath}/Photo/images/login.jpg" class="img-fluid w-100">
			</div>
			<div class="col-md-12 col-lg-6 bg-success p-5">
				...
				<form action="${pageContext.request.contextPath}/PatientLogin" method="post" class="was-validated">
					...
					<br> <br> <span class="text-white">Don't have an
						account? </span><a href="/HMS_Cubeten/login/patientRegister.jsp">Register</a>
				</form>
			</div>
		</div>
	</div>
