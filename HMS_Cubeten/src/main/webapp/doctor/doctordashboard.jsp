		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-white">
					<li class="text-center h4 fw-bold">DOCTOR DASHBOARD</li>
				</ul>
				<div class="dropdown">
					<a
					...
					<ul class="dropdown-menu dropdown-menu-end my-4"
						...
						<li><a class="dropdown-item" href="doctor/patienthistory.jsp"
	...
	<div class="container-fluid">
		<div class="row">
			<div class="bg-dark text-white fs-1 text-center fixed-top mt-5"
				...
				<div class="dropend">
					<a class="align-items-center" href="doctor/patienthistory.jsp"
						target="frame" id="navbarDropdownMenuAvatar" role="button"><img
				...
				<div class="dropend">
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						aria-labelledby="navbarDropdownMenuAvatar">
						<li><a class="dropdown-item" href="doctor/patienthistory.jsp"
							target="frame">OPD Patients</a></li>
						<li><a class="dropdown-item" href="doctor/ipdpatients.jsp"
							target="frame">IPD Patients</a></li>
					</ul>
				</div>
				<div class="dropend">
					<a class="dropdown-toggle align-items-center hidden-arrow" href="#"
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						aria-labelledby="navbarDropdownMenuAvatar">
						<li><a class="dropdown-item" href="test/viewResult.jsp"
							target="frame">View OPD Test Result</a></li>
						<li><a class="dropdown-item" href="test/viewIPDResult.jsp"
							target="frame">View IPD Test Result</a></li>
						<li><a class="dropdown-item" href="doctor/view_ipd_chart.jsp"
							target="frame">View ipd chart</a></li>
					</ul>
				</div>
			</div>
			<iframe src="doctor/patienthistory.jsp" width="100%" id="frame"
