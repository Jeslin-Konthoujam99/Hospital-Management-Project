		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-white">
					<li class="text-center h4 fw-bold">PHARMA DASHBOARD</li>
				</ul>
				<div class="dropdown">
					<a
			...
			<div class="bg-dark text-white fs-1 text-center fixed-top mt-5"
				...
				<div class="dropend">
					...
					<ul class="ms-4 dropdown-menu dropdown-menu-end"
						aria-labelledby="navbarDropdownMenuAvatar">
						<li><a class="dropdown-item" href="pharma/add_medicine.jsp"
							target="frame">ADD MEDICINE </a></li>
						
						<li><a class="dropdown-item" href="pharma/view_medicine.jsp"
							target="frame">UPDATE MEDICINE</a></li>
					</ul>
				</div>

			</div>
			<iframe src="pharma/view_medicine.jsp" width="100%" id="frame"
